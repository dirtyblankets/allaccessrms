        ...
        @if (Auth::user()->is('owner|admin'))
            ...
            @if (Auth::user()->can('view.events'))
                <li {{ Request::is('events') ? 'class=active' : '' }}>
                    <a href="{{ URL::route('admin::events') }}" title="Manage Events" data-toggle="tooltip" data-placement="right">
            ...
            @if (Auth::user()->can('view.users'))
                <li {{ Request::is('users') ? 'class=active' : '' }}>
                    <a href="{{ URL::route('admin::users') }}" title="Manage Users" data-toggle="tooltip" data-placement="right">
            ...
            @if (Auth::user()->can('view.organizations'))            
                <li {{ Request::is('organizations') ? 'class=active' : '' }}>
                    <a href="{{ URL::route('admin::organizations') }}" title="Manage Partners" data-toggle="tooltip" data-placement="right">
