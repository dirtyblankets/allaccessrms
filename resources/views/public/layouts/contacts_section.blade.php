...
<section id="contact" class="container content-section text-center">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <h2>Contact All Access</h2>
            <p>Feel free to email us if you have any questions or would simply like to say Hi !</p>
            <p><a href="mailto:allaccessrms@allaccessrms.com">contactus@allaccessrms.com</a>
            </p>
